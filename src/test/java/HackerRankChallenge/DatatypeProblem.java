...
public class DatatypeProblem {
	 ...
	 * long, float, and double. For this exercise, we'll work with the primitives used to hold integer values 
...
Explanation
 ...
 is very large and is outside of the allowable range of values for 
